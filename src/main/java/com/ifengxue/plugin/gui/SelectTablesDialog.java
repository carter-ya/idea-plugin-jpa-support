    ...
    public void run() {
      ...
      for (Table table : tableList) {
        ...
        generatorConfig.setTablesConfig(new TablesConfig()
            ...
            .setUseTimestampAnnotation(autoGeneratorSettingsState.isGenerateTimestampAnnotation())
            .setCreationTimestampPatterns(autoGeneratorSettingsState.getCreationTimestampPatterns())
            .setUpdateTimestampPatterns(autoGeneratorSettingsState.getUpdateTimestampPatterns())
